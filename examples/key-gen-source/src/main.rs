//! An example for simple User Defined Source which generates messages with keys.
//! It generates a continuous increasing sequence of offsets
//! and some data for each call to [`numaflow::source::sourcer::read`].

#[tokio::main]
async fn main() -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    // Split keys string into vector of String
    ...
    let source_handle = simple_source::KeyGenSource::new(keys);
