...
pub mod source_server {
    ...
    pub trait Source: std::marker::Send + std::marker::Sync + 'static {
        ...
        ) -> std::result::Result<tonic::Response<Self::ReadFnStream>, tonic::Status>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/source.v1.Source/PartitionsFn" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PartitionsFnSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "source.v1.Source";
