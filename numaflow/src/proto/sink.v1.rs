        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sink.v1.Sink/SinkFn" => {
                    ...
                    impl<T: Sink> tonic::server::StreamingService<super::SinkRequest> for SinkFnSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move { <T as Sink>::sink_fn(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                ...
                "/sink.v1.Sink/IsReady" => {
                    ...
                    impl<T: Sink> tonic::server::UnaryService<()> for IsReadySvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move { <T as Sink>::is_ready(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
